...
def test_quality_report_scores_existing_document_artifacts(tmp_path):
    ...
    _write_section(
        ...
        "r0",
        (
            "Philomena Hoffmann is identified as a German national holding the role "
            "of chief executive officer. The record places Philomena Hoffmann in "
            "the persons section for identity and procedural role only. Her details "
            "are presented without further allegation, and the section records her "
            "name, nationality and role as the relevant identifying particulars. "
            "Those particulars are maintained consistently for the purposes of the "
            "case record and do not introduce additional chronology."
        ),
    )
    _write_section(
        context.output_dir,
