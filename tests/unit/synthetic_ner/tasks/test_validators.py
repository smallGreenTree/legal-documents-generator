...
## Counts
- Fraud by false representation | Fraud Act 2006 | between 1 January 2025 and
  31 January 2025 causing loss of £10,000.

## Amounts
- Total alleged loss: £10,000
...
def test_validate_section_text_flags_unknown_amounts():
    issues = validate_section_text(
        section_name="facts",
...
def test_validate_section_text_respects_disabled_validator():
    issues = validate_section_text(
        section_name="facts",
        section_text="Alice Smith caused loss of £99,999 through ACME TRADING LTD.",
        memory_text=MEMORY_TEXT,
