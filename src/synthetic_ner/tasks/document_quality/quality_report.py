...
from src.synthetic_ner.tasks.document_generation.validators import validate_section_text
...
def _score_section(
    *,
    ...
    issues = validate_section_text(
        ...
        memory_text=memory_text,
        word_target=word_target,
        enabled_validators=getattr(getattr(context, "workflow_cfg", None), "validators", None),
    )
