...
from src.synthetic_ner.tasks.document_generation.constants import (
    BROKEN_TIMELINE_RE as _BROKEN_TIMELINE_RE,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    CASE_REF_RE,
    DATE_RE,
...
from src.synthetic_ner.tasks.document_generation.constants import (
    DANGLING_BETWEEN_RE as _DANGLING_BETWEEN_RE,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    INCOMPLETE_RANGE_RE as _INCOMPLETE_RANGE_RE,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    MARKDOWN_BOLD_RE as _MARKDOWN_BOLD_RE,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    MARKDOWN_BULLET_RE as _MARKDOWN_BULLET_RE,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    MARKDOWN_HEADING_RE as _MARKDOWN_HEADING_RE,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    MARKDOWN_NUMBERED_RE as _MARKDOWN_NUMBERED_RE,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    MARKDOWN_RULE_RE as _MARKDOWN_RULE_RE,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    META_LINE_LABELS as _META_LINE_LABELS,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    META_LINE_PREFIXES as _META_LINE_PREFIXES,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    META_SUMMARY_OPENING_RE as _META_SUMMARY_OPENING_RE,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    META_TOKEN_RE as _META_TOKEN_RE,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    PLACEHOLDER_STARS_RE as _PLACEHOLDER_STARS_RE,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    SECTION_ENTITY_CHECK as _SECTION_ENTITY_CHECK,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    THINK_RE as _THINK_RE,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    TRUNCATED_END_RE as _TRUNCATED_END_RE,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    VAT_LABEL_RE as _VAT_LABEL_RE,
)
from src.synthetic_ner.tasks.document_generation.constants import (
    WORD_COUNT_RE as _WORD_COUNT_RE,
)
from src.synthetic_ner.tasks.document_generation.context.facts import (
    collect_allowed_facts_from_memory,
    normalize_title_phrase,
)
from src.synthetic_ner.tasks.document_generation.validation.contracts import (
