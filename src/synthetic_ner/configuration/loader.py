"""Load and validate application and case configuration."""
    ...
    *,
    ...
    return WorkflowConfig(
        ...
        polisher=PolisherConfig(
            active=_require_bool(
                polisher.get("active", True),
                "workflow.polisher.active",
            ),
            temperature=_require_number(
                polisher["temperature"],
                "workflow.polisher.temperature",
            ),
            max_output_tokens=_require_positive_int(
                polisher["max_output_tokens"],
                "workflow.polisher.max_output_tokens",
            ),
        ),
        critic=critic_cfg,
